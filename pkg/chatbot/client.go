// Package chatbot provides an interface for AI chat clients to send messages and receive responses.
//
// Example usage:
//
//	package main
...
//	import (
//		"context"
//		"github.com/yourorg/yourrepo/pkg/chatbot"
//	)
//
//	func main() {
//		config := chatbot.Config{ /* ... */ }
//		client := chatbot.NewClient(config)
//		client.Init()
...
//go:generate mockgen -destination=client_mock.go -package=chatbot . Client
