...
// Source: github.com/utsabbera/task-master/core/task (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen -destination=repository_mock.go -package=task . Repository
//
...
func (m *MockRepository) Create(arg0 *Task) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Get(arg0 string) (*Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) List() ([]*Task, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 *Task) error {
	m.ctrl.T.Helper()
